...
| `docs/progress/new-sic/session-builder-core/diagram-language-research.md` | Research/progress note overlaps diagram specs. | Git history; DiagramSequence/diagram contract docs. | medium | Preserve any current diagram vocabulary first. |
