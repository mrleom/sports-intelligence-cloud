...
| Diagram pattern | Setup and Action panels preserve player identities and roles. Activity 1 shows a passing-to-turnover reaction. Activity 2 shows the loss trigger, nearest-player pressure, cover, inside recovery, and a red counter pair. Activity 3 releases a higher counter runner toward a central danger lane. Activity 4 uses a directional final-game grid with compact-recovery scoring. |
